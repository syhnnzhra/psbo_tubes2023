...
$riwayat = query("SELECT * FROM riwayat r JOIN masyarakat m ON r.id_masyarakat = m.id_masyarakat 
JOIN kurir k ON r.id_kurir= k.id_kurir JOIN sampah s ON r.id_sampah= s.id_sampah JOIN penjemputan pj ON r.id_penjemputan= pj.id_penjemputan "); 
...
<head>
    ...
    <title>WeGreen | Riwayat Penjemputan</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center mb-4">
                        <h1 class="h3 mb-0 text-gray-800 text-center">History Penjemputan</h1>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 text-center font-weight-bold text-gray-800">70</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs text-center font-weight-bold text-info text-uppercase mb-1">
                                                Permintaan Penjemputan</div>
                                            <div class="h5 mb-0 text-center font-weight-bold text-gray-800">20</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs text-center font-weight-bold text-success text-uppercase mb-1">
                                                Penjemputan Berhasil</div>
                                            <div class="h5 mb-0 text-center font-weight-bold text-gray-800">100</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs text-center font-weight-bold text-danger text-uppercase mb-1">
                                                Penjemputan Gagal</div>
                                            <div class="h5 text-center mb-0 font-weight-bold text-gray-800">18</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card mb-3" style="max-width: 540px; background-color: #0174BE;">
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="card-body">
                                                                        <h5 class="card-text text-white"><?= $r["nama"]; ?></h5>
                                                                        <p class="card-text text-white"><?= $r["alamat"]; ?></p>
                                                                        <p class="card-text text-white"><?= $r["no_telp"]; ?></p>
                                                                    </div>         
                                                                </div>
                                                            </div>
                                                        </div>
